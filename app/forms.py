...
class SignUpForm(Form):
  ...
  email = TextField('first_email', validators = [Required(), v.Email(), v.EqualTo('confirm_email', message = "Emails have to match")])
  confirm_email = TextField('Repeat Email')
  password = PasswordField('first_password', validators = [Required(), v.EqualTo('confirm_password', message = 'Passwords must match')])
